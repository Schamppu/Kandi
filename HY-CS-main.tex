...
\documentclass[finnish,twoside,censored,tkt,software-track-2020]{HYthesisML} 
...
\title{Lohkoketjujen hajautettujen konsensusmekanismien energiatehokkuus ja ympäristöystävällisyys}
...
\supervisors{J.~N.~Alanko}
\examiners{K. Heljanko}

\keywords{blockchain, consensus mechanisms, energy efficiency}
...
\include{Ch.20_Esittely}
\include{Ch.30_Vertailu}
\include{Ch.40_Yhteenveto}
